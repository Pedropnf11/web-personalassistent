...
function WorkoutPlayer({ workout, onClose }: WorkoutPlayerProps) {
    ...
    const [timeLeft, setTimeLeft] = useState(60) // Default 60s rest/exercise
    ...
    const exercises: Exercise[] = [
        {
            ...
            reps: '3x 12',
            videoId: 'J0DnG1_S92I',
            description: 'Mantenha as mãos juntas em forma de diamante. Desça o peito até tocar nas mãos.'
        },
        {
            id: 2,
            ...
            reps: '4x 15',
            videoId: 'Tu8hLUd_tVQ',
            description: 'Desça controlado e suba explodindo, saltando levemente no topo.'
        },
        {
            id: 3,
            name: 'Burpees',
            reps: '3x 10',
            videoId: 'auBLPxo8Fww',
            description: 'Movimento completo: chão, flexão, salto.'
        }
    ]
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-2xl px-4">
                ...
                >
                    ...
                    <div className="relative z-20 flex flex-col items-center justify-center h-full">
                        ...
                        <span className="text-sm text-gray-300 mt-2">Seguir instrutor (YouTube)</span>
                    </div>
                </button>
                ...
                >
                    ...
                    <div className="relative z-20 flex flex-col items-center justify-center h-full">
                        ...
                        <span className="text-sm text-gray-300 mt-2">Cronómetro + Lista</span>
                    </div>
                </button>
            </div>
        </div>
    ...
    const renderGuidedPreview = () => (
        <div className="w-full max-w-2xl mx-auto h-full flex flex-col justify-center p-8 animate-fadeIn">
            <div className="text-center mb-8">
                <h2 className="text-3xl font-bold text-white mb-2">{workout?.title || 'Treino do Dia'}</h2>
            ...
            <div className="bg-void-card border border-void-border rounded-3xl p-6 mb-8 max-h-[60vh] overflow-y-auto custom-scrollbar">
                ...
                <div className="space-y-4">
                    {exercises.map((ex, index) => (
                        <div key={ex.id} className="flex items-center justify-between p-4 bg-void-dark rounded-xl border border-white/5 hover:border-primary/30 transition-colors">
                            ...
                            <div className="text-right">
                                <span className="text-primary-glow font-mono font-bold">{ex.reps}</span>
                            </div>
                        </div>
                    ))}
                </div>
            ...
            <div className="w-full max-w-4xl mx-auto h-full flex flex-col p-4 animate-fadeIn">
                ...
                <div className="flex justify-between items-center mb-8">
                    ...
                    <div className="flex gap-1">
                        {exercises.map((_, i) => (
                            <div key={i} className={`h-1.5 w-8 rounded-full transition-colors ${i <= currentExerciseIndex ? 'bg-primary' : 'bg-white/10'}`} />
                        ))}
                    </div>
                    <button onClick={() => setMode(null)} className="text-sm text-gray-500 hover:text-white">Sair</button>
                </div>

                {/* Exercise Content - Centered Layout (No Video) */}
                <div className="flex-1 flex flex-col items-center justify-center">
                    <div className="bg-void-card border border-void-border rounded-3xl p-8 md:p-12 shadow-2xl relative overflow-hidden text-center w-full max-w-3xl">
                        ...
                        <p className="text-gray-400 text-lg mb-12 max-w-2xl mx-auto leading-relaxed relative z-10 animate-slideUp delay-200">
                        ...
                        <div className="bg-void-dark rounded-2xl p-8 border border-white/5 mb-8 flex flex-col md:flex-row items-center justify-between gap-6 max-w-2xl mx-auto hover:border-primary/30 transition-colors duration-300 relative z-10 animate-slideUp delay-300">
                            <div className="text-left">
                                <p className="text-xs text-gray-500 uppercase tracking-widest mb-1">Cronómetro</p>
        ...
        <div className="fixed inset-0 z-[100] bg-void-obsidian flex flex-col animate-[fadeIn_0.3s_ease-out]">
            ...
            <div className="px-8 py-4 border-b border-void-border flex justify-between items-center bg-void-dark">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="font-bold text-white">{workout?.title || 'Treino do Dia'}</h1>
                        <p className="text-xs text-primary-glow">Em progresso...</p>
                    </div>
                </div>
